...
func NewRouter(handler *gin.Engine, l logger.Interface, corsOrigins []string, store sessions.RedisStore, userService service.UserService, authService auth.AuthService) {
